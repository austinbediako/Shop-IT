        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              <div className="text-2xl tracking-wider font-semibold">{sProduct.pName}</div>
              <div className="flex justify-between items-center mt-2">
                <span className="text-2xl font-bold text-gray-900">
                  GH₵{sProduct.pPrice}.00
                </span>
                <span>
                  <svg
                    ...
                    } w-6 h-6 md:w-8 md:h-8 cursor-pointer text-blue-600 hover:scale-110 transition-transform`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                {sProduct.pQuantity !== 0 ? (
                  <Fragment>
                    ...
                    layoutData.inCart.includes(sProduct._id) === true ? (
                      <div
                        className={`px-8 py-3 bg-gray-400 text-white rounded-none font-semibold text-center cursor-not-allowed uppercase w-full`}
                      >
                        In cart
                      </div>
                    ) : (
                      <div
                        ...
                        className={`px-8 py-3 bg-blue-600 hover:bg-blue-700 transition-colors rounded-none font-semibold text-white text-center cursor-pointer uppercase w-full`}
                      >
                        Add to cart
                      </div>
                    )}
                  ...
                  <Fragment>
                    ...
                    layoutData.inCart.includes(sProduct._id) === true ? (
                      <div
                        className={`px-8 py-3 bg-gray-400 text-white rounded-none font-semibold text-center cursor-not-allowed uppercase w-full opacity-75`}
                      >
                        In cart
                      </div>
                    ) : (
                      <div
                        disabled={true}
                        className="px-8 py-3 bg-gray-400 text-white rounded-none font-semibold opacity-50 cursor-not-allowed text-center uppercase w-full"
                      >
                        Out of stock
                      </div>
                    )}
