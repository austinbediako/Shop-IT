        ...
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          <div className="flex items-center justify-between w-full pt-4">
            ...
            <span
              ...
              className="cursor-pointer text-gray-100 py-2 px-2 rounded-none-none"
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={editformData.pImages[0].match(/^https?:\/\//) ? editformData.pImages[0] : `${apiURL}/uploads/products/${editformData.pImages[0]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={editformData.pImages[1].match(/^https?:\/\//) ? editformData.pImages[1] : `${apiURL}/uploads/products/${editformData.pImages[1]}`}
                    alt="productImage"
                  />
                </div>
              ) : (
            ...
            <div className="flex flex-col space-y-1 w-full pb-4 md:pb-6 mt-4">
              <button
                style={{ background: "#303031" }}
                type="submit"
                className="rounded-none-none bg-gray-800 text-gray-100 text-lg font-medium py-2"
              >
                Update product
              </button>
            </div>
