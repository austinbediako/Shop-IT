      ...
      <tr>
        ...
        <td className="p-2 text-center">
          <img
            ...
            src={category.cImage.match(/^https?:\/\//) ? category.cImage : `${apiURL}/uploads/categories/${category.cImage}`}
            alt=""
          />
        </td>
        <td className="p-2 text-center">
          {category.cStatus === "Active" ? (
            <span className="bg-green-200 rounded-none-none text-center text-xs px-2 font-semibold">
              {category.cStatus}
            </span>
          ) : (
            <span className="bg-red-200 rounded-none-none text-center text-xs px-2 font-semibold">
              {category.cStatus}
            </span>
          )}
        </td>
